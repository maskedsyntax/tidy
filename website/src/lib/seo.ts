...
export const site = {
	...
	url: 'https://tidy.maskedsyntax.com',
	locale: 'en_US',
	twitter: '',
	github: 'https://github.com/maskedsyntax/tidy',
	support: 'https://tidy.maskedsyntax.com/support',
	privacy: 'https://tidy.maskedsyntax.com/privacy',
	terms: 'https://tidy.maskedsyntax.com/terms',
	keywords: [
		'Tidy',
		'AI todo app',
		'desktop todo',
